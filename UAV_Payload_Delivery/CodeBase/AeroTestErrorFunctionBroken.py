...
t_steps = np.arange(0,125, VPC.dT)

n_steps = len(t_steps)

targetAirspeeds = np.linspace(25,35, 10)
targetAltitudes = np.linspace(25, 200, 10)
...
def evaluateError(targetVa,targetAlt):
    ...
    pdc = PDC.PayloadDeliveryControl(States.vehicleState(pn=1000,pe=1000))
    ...
    #print("airspeed =",targetAirspeeds[i],"altitude =",targetAltitudes[j])
