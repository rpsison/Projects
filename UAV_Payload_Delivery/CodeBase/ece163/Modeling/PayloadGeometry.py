...
class VehicleGeometry():
	def __init__(self):
		...
		self.scene = pywavefront.Wavefront("ball.obj",create_materials=True, collect_faces=True)
		
		


		self.vertices = mm.scalarMultiply(baseUnit, self.scene.vertices) 
		
		self.vertices = mm.multiply(self.vertices, Rotations.euler2DCM(-math.pi/2, -math.pi/2, 0))
		#self.vertices = mm.offset(self.vertices, -.5,2,0)
