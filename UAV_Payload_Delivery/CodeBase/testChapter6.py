"""
Test harness for Lab4.
Runs the VehicleClosedLoopControl.Update in several cases.
Semiautomautomatically calls Update, takes sample data of the results, and graphs them
"""
import math
